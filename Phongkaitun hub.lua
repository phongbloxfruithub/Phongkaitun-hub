	...
	getgenv()['Check_Setting'] = function(Name)
		if not _G.Dis and not isfolder('phongdz Hub Srcipt Folder') then
			makefolder('phongdz Hub Srcipt Folder')
		end
		if not _G.Dis and not isfile('phongdz Hub Srcipt Folder/'..Name..'.json') then
			writefile('phongdz Hub Srcipt Folder/'..Name..'.json',JsonEncode(_G.Setting_table))
		end
	end
	getgenv()['Get_Setting'] = function(Name)
		if not _G.Dis and isfolder('phongdz Hub Srcipt Folder') and isfile('phongdz Hub Srcipt Folder/'..Name..'.json') then
			_G.Setting_table = JsonDecode(readfile('phongdz Hub Srcipt Folder/'..Name..'.json'))
...
do
	local ui = game:GetService("CoreGui").RobloxGui.Modules.Profile:FindFirstChild("phongdz")
	if ui then 
		ui:Destroy()
	end
end
...
local phongdz = Instance.new("ScreenGui")

phongdz.Name = "phongdz"
phongdz.Parent = game:GetService("CoreGui").RobloxGui.Modules.Profile
phongdz.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
